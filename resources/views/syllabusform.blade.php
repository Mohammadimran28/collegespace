...
<h3 class="text-center text-primary">
        ...
        <input type="file" name="syllabusfile" id="" class="form-control"/>
        <span class="text-danger">
        @error('syllabusfile')
        {{$message}}
        @enderror
        ...
        <a href="{{route('syllabus.store')}}"><input type="Submit" name="submit" id="" class="form-control btn btn-success"/>
        </a>
        </div>
