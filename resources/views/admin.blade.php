  ...
  border-radius: 0.25rem !important;
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">CollegeSpace</a>
            <!-- Sidebar Toggle-->
...
<<<<<<< HEAD
                        <h1 class="mt-4">Select for adding New Record</h1>
...
<<<<<<< HEAD
                                        <a class="small text-white stretched-link" href="{{route('notes.form')}}">Add New</a>
=======
...
<<<<<<< HEAD
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="{{route('syllabus.form')}}">Add New</a>
=======
                                    <div class="card-body">Syallabus</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
>>>>>>> e67275be0b50f806e991dff451c5f1ac24384a31
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Time Table</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
<<<<<<< HEAD
                                        <a class="small text-white stretched-link" href="{{route('timetable.form')}}">Add New</a>
=======
                                        <a class="small text-white stretched-link" href="#">View Details</a>
>>>>>>> e67275be0b50f806e991dff451c5f1ac24384a31
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Exam Paper</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
<<<<<<< HEAD
                                        <a class="small text-white stretched-link" href="{{route('exampaper.form')}}">Add New</a>
=======
                                        <a class="small text-white stretched-link" href="#">View Details</a>
>>>>>>> e67275be0b50f806e991dff451c5f1ac24384a31
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
